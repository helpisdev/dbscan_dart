...
The `<id>` should be a unique identifier that is of the form `iflow_consumer_app.library.Class.member[.optionalDescription]`.
For example:

```dart
// GOOD:
/// {@template iflow_consumer_app.rendering.Layer.findAnnotations.aboutAnnotations}
